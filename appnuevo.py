...
if model_features and scaler_features:
    ...
    if set(input_data.columns) != set(model_features):
    ...
    st.error("No se pudieron cargar las características del modelo o escalador.")
