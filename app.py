 ...
 "cells": [
  {
   ...
   "id": "4ffda6e7-40a9-4899-b67a-b4b3ef8c6d82",
   "metadata": {},
   "outputs": [],
   "source": [
    ...
    "    st.write(f\"Columnas en input_data_df: {list(input_data_df.columns)}\")\n",
    "    st.write(f\"Columnas esperadas por el escalador: {scaler.feature_names_in_}\")\n",
    "\n",
    "    # Escalar los datos\n",
